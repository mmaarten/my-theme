...
class Templates
{
    ...
    public static function button($args)
    {
        ...
        echo '<a' . Helpers::htmlAtts($atts) . '>' . $args['text'] . '</a>';
    }
    ...
    public static function carousel($args)
    {
        ...
        echo '<div' . Helpers::htmlAtts($atts) . '>';
        ...
        if ($args['indicators']) {
            ...
            for ($i=0; $i < count($items); $i++) {
                ...
                echo '<li' . Helpers::htmlAtts($indicator_atts) . '></li>';
            }
        ...
        for ($i=0; $i < count($items); $i++) {
            ...
            echo '<div' . Helpers::htmlAtts($item_atts) . '>';
    ...
    public static function modal($args)
    {
        ...
        echo '<div' . Helpers::htmlAtts($modal_atts) . '>';
        echo '<div' . Helpers::htmlAtts($dialog_atts) . '>';
